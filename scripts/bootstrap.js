...
$btn.button('toggle')
e.preventDefault()})}(jQuery);+function($){"use strict";var Popover=function(element,options){this.init('popover',element,options)}
...
$carousel.carousel($carousel.data())})})}(jQuery);+function($){"use strict";function ScrollSpy(element,options){var href
...
$spy.scrollspy($spy.data())})})}(jQuery);+function($){"use strict";var Collapse=function(element,options){this.$element=$(element)
...
$this[$target.hasClass('in')?'addClass':'removeClass']('collapsed')}$target.collapse(option)})}(jQuery);+function($){"use strict";var Tab=function(element){this.element=$(element)}
